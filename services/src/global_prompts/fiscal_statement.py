...
<FISCAL_YEAR_DEFINITION>Standard fiscal year runs from November 1st through October 31st. Note: Individual banks may have different fiscal year definitions.</FISCAL_YEAR_DEFINITION>
</FISCAL_CONTEXT>"""
