...
**Section ID:** `outlook`  
**Enabled Widgets:** qa, exec, data

## Section Context

<section_context>
<section_name>Outlook</section_name>
<focus_areas>
- Quantitative guidance for next quarter/year (revenue, expenses, growth rates)
- Strategic initiative announcements and timeline commitments
- Management confidence language and certainty indicators
- Long-term objective statements and investment priorities
...
<widget name="data">Extract and organize quantitative data into structured format:
...
Present data in table format when possible, with clear labels and time periods.</widget>
</analysis_requirements>
</section_context>
